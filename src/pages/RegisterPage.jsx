...
function RegisterPage() {
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[#f3f8ff] px-5 py-12 font-['Inter'] md:px-8 lg:px-12">
      ...
      <section className="relative mx-auto flex min-h-[78vh] w-full max-w-7xl items-center justify-between gap-10 rounded-3xl border border-white/50 bg-white/40 p-6 backdrop-blur-sm lg:p-10">
        <BrandPanel />
        <RegisterFormPanel />
      </section>
